...
const StudentService = (studentRepository) => ({
    createStudent: (studentPayload) => __awaiter(void 0, void 0, void 0, function* () {
        return yield studentRepository.createStudent(studentPayload);
    }),
    ...
    updateStudent: (uuid, updates) => __awaiter(void 0, void 0, void 0, function* () {
        return yield studentRepository.updateStudent(uuid, updates);
    })
});
